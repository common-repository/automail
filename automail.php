 ...
 *
 * @wordpress-plugin
 * Plugin Name:       AutoMail - Event-driven Email Automation. Easy email Notification and Auto-reply.
...
if ( function_exists( 'automail_fs' ) ) {
    automail_fs()->set_basename( false, __FILE__ );
} else {
